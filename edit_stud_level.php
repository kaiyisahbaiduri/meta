 ...
 if(isset($_POST['edit']))
{
    ...
    $result = mysqli_query($conn,"update tblleavetype set LeaveType='$leavetype' where id = '$get_id' ");
    if ($result) {
							...
							<div class="col-md-6 col-sm-12">
								...
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Edit Student Level</li>
									</ol>
								</nav>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">Edit Student Level</h2>
								<section>
									<?php
