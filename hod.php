	...
	<div class="main-container">
		<div class="pd-ltr-20">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">ALL HOD</h2>
					</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								 ...
								 <?php
		                         $teacher_query = mysqli_query($conn,"select * from tblemployees LEFT JOIN tbldepartments ON tblemployees.Department = tbldepartments.DepartmentShortName where role = 'HOD' ORDER BY tblemployees.emp_id") or die(mysqli_error());
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											<a class="dropdown-item" href="edit_hod.php?edit=<?php echo $row['emp_id'];?>"><i class="dw dw-edit2"></i> Edit</a>
