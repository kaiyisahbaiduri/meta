...
<?php
	...
	<?php
        ...
        mysqli_query($conn,"INSERT INTO tblemployees(FirstName,EmailId,Password,Gender,Dob,Department,Address,role,Phonenumber,Status, location, Staff_ID, Position_Staff) VALUES('$fname','$email','$password','$gender','$dob','$department','$address','$user_role','$phonenumber','$status', 'NO-IMAGE-AVAILABLE.jpg','$staff_id','$position_staff')         
		") or die(mysqli_error()); ?>
		<script>alert('Subject Successfully Saved');</script>;
		<script>
