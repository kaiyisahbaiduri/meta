...
<?php
	...
	<?php
		...
		") or die(mysqli_error()); ?>
		<script>alert('Coordinator Records Successfully  Added');</script>;
		<script>
		window.location = "coor.php"; 
		</script>
		<?php   }
}
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Coordinator Portal</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="admin_dashboard.php">Dashboard</a></li>
									<li class="breadcrumb-item active" aria-current="page">Coordinator Module</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Coordinator Form</h4>
							<p class="mb-20"></p>
						</div>
					</div>
						...
						<form method="post" action="">
							<section>
								...
								<div class="row">
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label >Coordinator Position :</label>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="add_staff" id="add_staff" data-toggle="modal">Add&nbsp;Coordinator</button>
											</div>
										</div>
									</div>
								</div>
